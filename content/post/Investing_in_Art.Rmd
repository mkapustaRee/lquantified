...
The inspiration to write this blog post was the documentary about the life of famous "con" artist Mr. Beltracchi [link](<http://www.imdb.com/title/tt3212568/>)! The documentary got me curious about art trading & auctions! Also, I often heard in the media saying: **"Invest in fine Art, is a great investment!"** . In the finance world, banks offer clients services such as **Art Consulting**. The service offers advice on buying and selling fine art. The key to a great advice, is to know which Artist artwork is increasing in value over time and generate profits at the auctions.  
...
Unfortunately, the data are still locked in the records (strings). The Information is extracted using string manipulation (stringr, rebus) into **separate** columns:
